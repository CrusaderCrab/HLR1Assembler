...
case 1: rr(s.m_opcodePath=="./HLR1_Default_Opcodes.txt");
...
TEST_CASE("Correctly parse good arguments", "[State]"){
    ...
    args[0] = "PROGRAM NAME";
    args[1] = "-c";
    args[2] = "./HLR1_Default_Config_ALT.txt";
    args[3] = "-oc";
    args[4] = "./HLR1_Default_Opcodes_ALT.txt";
    args[5] = "-i";
    ...
    SECTION("Correctly Read new config file argument"){
        HLR1::State s(3, args);
        rr(s.m_configPath=="./HLR1_Default_Config_ALT.txt");
        checkAllDefaultFrom(1, s);
    }
    SECTION("Correctly Read new OpCode File argument"){
        HLR1::State s(5, args);
        rr(s.m_configPath=="./HLR1_Default_Config_ALT.txt");
        rr(s.m_opcodePath=="./HLR1_Default_Opcodes_ALT.txt");
...
TEST_CASE("Correctly reject bad arguments", "[State]"){
    SECTION("Invalid Flag"){
        ...
        args[0] = "PROGRAM NAME";
        args[1] = "-c";
        args[2] = "./HLR1_Test_Config_ALT.txt";
        args[3] = "-t";
